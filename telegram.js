...
// force IPv4 + longer timeout. gramjs picks port automatically.
function clientOptions() {
  return {
    connectionRetries: 3,
    timeout: 30,
    useIPV6: false,
    // force the connection object to TCP (not WebSocket)
    connection: undefined, // let gramjs pick, but with IPv4 only
  };
}
